...
A unifrom non informative prior was used to get the posterior distribution given the data. The ‘R’ in the prior stands for residual variance and G stands for the variance due to the random eﬀects. The prior distibution is the package is paramaterised to nu and V4. In this study the values are set at what is considered to be classical. This prior was good enough for all the models of traits studied in the three regions.  
...
```{r}
# set priors 
modPrior=list(R=list(V=1, n=0.002), # V = variance set to 1 as default
               G=list(G1=list(V=1, n=0.002),
               G2=list(V=1, n=0.002)))
